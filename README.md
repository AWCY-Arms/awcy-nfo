...
- declare section titles, alignment, spacing, and subheaders easily. 
- mix/nest yaml data structures to create complex layouts. 
- choose from multiple headers and styles or create your own.
